...
public class CalenderAdapter extends RecyclerView.Adapter<CalenderAdapter.ViewHolder> {
    ...
    public void setOnItemClickListener(CalenderAdapter.OnItemClickListener listener) {
    ...
    public CalenderAdapter(ArrayList<HomeData> mSearchData) {
    ...
    public CalenderAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        CalenderAdapter.ViewHolder viewHolder = new CalenderAdapter.ViewHolder(view);
        return viewHolder;
    }
